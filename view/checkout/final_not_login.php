<div id="content">
    ...
    <p>An email confirmation has been sent to your email address. <a href="?mod=checkout&act=receipt&x=<?php echo $_SESSION['order_id'] . '&y=' . sha1($_SESSION['email']); ?>&z=0" style="display: inline-block;" target="_blank">Click here</a> to create a printable receipt of your order.</p>
</div>