...
if (is_login()) {
       shopping_cart_add_product(CART_LOGIN, WISHLIST, $cart_id, $_SESSION['user_id'], (int)$_POST['id'], $attributes,  $num_cart);
       $message = 'You added '.$num_cart.' products into wish list';
} else {
       shopping_cart_add_product(CART_NOT_LOGIN, WISHLIST, $cart_id, 0, (int)$_POST['id'], $attributes,  $num_cart);
       $message = 'You added '.$num_cart.' products into wish list';
}
echo $message;